...
export const USER_ROLES = [
  { value: "Product / Project Manager", i18n_label: "user_roles.product_or_project_manager" },
  { value: "Development / Engineering", i18n_label: "user_roles.development_or_engineering" },
  { value: "Founder / Executive", i18n_label: "user_roles.founder_or_executive" },
  { value: "Freelancer / Consultant", i18n_label: "user_roles.freelancer_or_consultant" },
  { value: "Marketing / Growth", i18n_label: "user_roles.marketing_or_growth" },
  { value: "Sales / Business Development", i18n_label: "user_roles.sales_or_business_development" },
  { value: "Support / Operations", i18n_label: "user_roles.support_or_operations" },
  { value: "Student / Professor", i18n_label: "user_roles.student_or_professor" },
...
export const IMPORTERS_LIST = [
  { provider: "github", type: "import", i18n_title: "importer.github.title", i18n_description: "importer.github.description" },
  { provider: "jira", type: "import", i18n_title: "importer.jira.title", i18n_description: "importer.jira.description" },
];

export const EXPORTERS_LIST = [
  { provider: "csv", type: "export", i18n_title: "exporter.csv.title", i18n_description: "exporter.csv.description" },
  { provider: "xlsx", type: "export", i18n_title: "exporter.excel.title", i18n_description: "exporter.csv.description" },
  { provider: "json", type: "export", i18n_title: "exporter.json.title", i18n_description: "exporter.csv.description" },
];

export const DEFAULT_GLOBAL_VIEWS_LIST: { key: TStaticViewTypes; i18n_label: string }[] = [
  { key: "all-issues", i18n_label: "default_global_view.all_issues" },
  { key: "assigned", i18n_label: "default_global_view.assigned" },
  { key: "created", i18n_label: "default_global_view.created" },
  { key: "subscribed", i18n_label: "default_global_view.subscribed" },
];
...
export const WORKSPACE_SIDEBAR_STATIC_NAVIGATION_ITEMS: Record<string, IWorkspaceSidebarNavigationItem> = {
  ...
  // PATCH v1.19: People page.
  people: {
    key: "people",
    labelTranslationKey: "People",
    href: `/people/`,
    access: [EUserWorkspaceRoles.ADMIN, EUserWorkspaceRoles.MEMBER],
    highlight: (pathname: string, url: string) => pathname.includes(url),
  },
  // PATCH v1.33f: Timesheet (Time Tracking report).
  // labelTranslationKey su stringa letterale come per "People".
  timesheet: {
    key: "timesheet",
    labelTranslationKey: "Timesheet",
    href: `/timesheet/`,
    access: [EUserWorkspaceRoles.ADMIN, EUserWorkspaceRoles.MEMBER],
    highlight: (pathname: string, url: string) => pathname.includes(url),
  },
