 ...
 *  Aggiunto state + render del MoveIssueModal e pass del setter ai menuItemProps.
 *  Lo helper.tsx (factory) decide di mostrare la voce "Move to project" solo
 *  se setMoveIssueModalOpen e' presente.
 */
