 ...
 *  Aggiunta route per la People page (Team dashboard frontend).
 *  Vedi anche:
 *    - apps/web/app/(all)/[workspaceSlug]/(projects)/people/*
 *    - packages/constants/src/workspace.ts (voce sidebar)
 *    - apps/api/plane/app/views/workspace/team_stats.py (backend v1.18)
 */
  ...
  layout("./(all)/layout.tsx", [
    ...
    layout("./(all)/[workspaceSlug]/layout.tsx", [
      ...
      layout("./(all)/[workspaceSlug]/(projects)/layout.tsx", [
        ...
        // People (plane-custom v1.19 - Team dashboard)
