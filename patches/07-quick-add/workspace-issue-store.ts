 ...
 *  Sblocca quickAddIssue nel WorkspaceIssues store. Stock lo dichiara
 *  esplicitamente `undefined` per disabilitarlo. La logica `issueQuickAdd`
 *  e' gia' implementata nella base class BaseIssuesStore (creazione
 *  optimistic con id temp + createIssue + cleanup), quindi basta
 *  ri-bindare al metodo della base.
 */
...
export class WorkspaceIssues extends BaseIssuesStore implements IWorkspaceIssues {
  ...
  // come `undefined` per disabilitare il quick-add nei workspace views.
