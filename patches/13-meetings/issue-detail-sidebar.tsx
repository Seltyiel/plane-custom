 ...
 *  Full-replacement del sidebar.tsx stock per iniettare IssueMeetingsProperty
 *  accanto a IssueWorklogProperty. 1 import + 1 render = unica differenza
 *  rispetto alla versione stock.
 */
...
// PATCH v1.34e: sezione Meetings linkati al task (custom).
      ...
      <div className="flex h-full w-full flex-col items-center divide-y-2 divide-subtle-1 overflow-hidden">
        <div className="h-full w-full overflow-y-auto px-6">
          ...
          <div className={`mt-4 mb-2 space-y-2.5 truncate ${!isEditable ? "opacity-60" : ""}`}>
            ...
            {/* PATCH v1.34e: sezione Meetings linkati al task. */}
