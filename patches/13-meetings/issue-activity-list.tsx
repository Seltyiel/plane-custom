 ...
 *  Full-replacement di activity-list.tsx stock per aggiungere il case
 *  "meeting" che rendererizza l'entry di scheduling/unlinking/cancellation
 *  di un meeting linkato all'issue.
 *
 *  Differenza vs stock: 1 import + 1 case nella switch.
 */
...
// PATCH v1.34h-4: meeting activity entry render.
import { IssueMeetingActivity } from "@/components/meetings/issue-meeting-activity";
...
export const IssueActivityItem = observer(function IssueActivityItem(props: TIssueActivityItem) {
  ...
  switch (activityField) {
    ...
    // PATCH v1.34h-4: meeting link/unlink/cancel events.
    case "meeting":
      return <IssueMeetingActivity {...componentDefaultProps} />;
    default:
