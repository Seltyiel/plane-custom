 ...
 *  Full-replacement di issue-blocks.tsx stock per renderizzare anche i
 *  meeting blocks accanto agli issue blocks dentro le day cells del
 *  Calendar layout. 1 import + 1 render JSX = unica differenza vs stock.
 *
 *  I meeting blocks sono fetchati una volta sola dal context provider
 *  MeetingsCalendarProvider (montato in base-calendar-root.tsx) per il
 *  range del mese visibile, evitando N richieste per N giorni.
 */
...
// PATCH v1.34f: meeting blocks renderer.
import { CalendarMeetingBlocks } from "@/components/meetings/calendar-meeting-blocks";
...
export const CalendarIssueBlocks = observer(function CalendarIssueBlocks(props: Props) {
  ...
  return (
    <>
      ...
      {/* PATCH v1.34f: meeting blocks per la stessa data. */}
      <CalendarMeetingBlocks date={date} />
