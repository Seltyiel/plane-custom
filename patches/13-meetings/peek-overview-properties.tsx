 ...
 *
 * PATCH (plane-custom) v1.34e-1:
 *  Full-replacement del peek-overview/properties.tsx stock per iniettare
 *  IssueMeetingsProperty accanto a IssueWorklogProperty (stesso pattern
 *  v1.34e applicato in issue-detail/sidebar.tsx).
 *  Differenza vs stock: 1 import + 1 render JSX.
 */
...
// PATCH v1.34e-1: sezione Meetings linkati al task (custom).
import { IssueMeetingsProperty } from "@/components/meetings/issue-meetings-property";
  ...
  return (
    <div>
      ...
      <div className={`mt-3 w-full space-y-3 ${disabled ? "opacity-60" : ""}`}>
        ...
        {/* PATCH v1.34e-1: sezione Meetings linkati al task. */}
        <IssueMeetingsProperty
          workspaceSlug={workspaceSlug}
          projectId={projectId}
          issueId={issueId}
          disabled={disabled}
