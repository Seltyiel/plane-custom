...
#  Aggiunto Project.is_hidden (BooleanField default False) per supportare
#  progetti "fittizi" workspace-level (Opzione A della milestone v1.22).
#  Vedi anche:
#    - migration-0123-project-is-hidden.py
#    - api-workspace-project-endpoint.py (lazy get_or_create del progetto)
#    - api-urls-workspace.py (route /workspace-project/)
#    - frontend project store filter su !is_hidden
...
class Project(BaseModel):
    ...
    # PATCH (plane-custom) v1.22a: flag per progetti "fittizi" workspace-level.
    # Quando is_hidden=True, il progetto non e' visibile nella sidebar Projects
    # ne' nei picker stock; serve solo da contenitore per task workspace-level
    # (no project context). Massimo 1 progetto hidden per workspace, creato
    # lazy dal endpoint /workspaces/<slug>/workspace-project/.
