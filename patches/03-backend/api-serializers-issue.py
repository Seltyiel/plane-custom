...
#   workspace). Necessario per consentire l'assegnazione di uno stato
#   condiviso v1.20a a un issue tramite il StateDropdown patchato v1.20d.
...
class IssueSerializer(BaseSerializer):
    ...
    def validate(self, data):
        ...
        # PATCH v1.20 hotfix #2 (+ #2b fallback): deriva workspace_id se mancante.
        _ws_id = None
