 ...
 * rejections. Quando cambia layout (List <-> Kanban <-> Calendar), la
 * fetch precedente viene abortita; workspace.service.ts trasforma
...
const swallowAbort = (e: unknown) => {
  ...
  console.warn("[plane-custom][base-calendar] fetch rejected:", e);
};
...
export const BaseCalendarRoot = observer(function BaseCalendarRoot(props: IBaseCalendarRoot) {
  ...
  const loadMoreIssues = useCallback(
    (dateString: string) => {
      ...
      fetchNextIssues(dateString)?.catch(swallowAbort);
    },
    [fetchNextIssues]
  );
