 ...
 *  Aggiunto "state_detail.group" a DRAG_ALLOWED_GROUPS.
 *  Senza, in workspace views / your-work / profile dove il group_by attivo
 *  e' "state_detail.group" (raggrupa per Backlog/Unstarted/Started/...
 *  perche' gli state UUID per-project non si possono raggrupare cross-project),
 *  il drag-and-drop era disabilitato col toast "Drag and drop is disabled
 *  for the current grouping" (block.tsx riga 199, isDraggingAllowed).
 *  Con questo flag attivo, il drop attiva handleGroupDragDrop che resolve
 *  lo state_id del project del task tramite getStatesByProject (vedi patch
 *  layouts-utils.tsx + base-list-root.tsx).
 */
...
export const DRAG_ALLOWED_GROUPS: TIssueGroupByOptions[] = [
  ...
  "module",
  "cycle",
  // PATCH v1.21: workspace views / your-work / profile usano questo group_by.
  // Il drop su un group "started"/"backlog"/... viene risolto in state_id
  // dentro handleGroupDragDrop tramite getStatesByProject (utils.tsx).
  "state_detail.group",
];
