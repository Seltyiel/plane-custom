 ...
 * Stessa logica di v1.23a: stock chiama
 *   allowPermissions([ADMIN,MEMBER], EUserPermissionsLevel.PROJECT)
 * senza passare slug/projectId. In cycle context standard projectId e'
 * nell'URL quindi il level si risolve correttamente e il comportamento
 * non cambia. La patch e' difensiva per non lasciare trappole se in
 * futuro questi dropdown vengono renderizzati in context senza
 * projectId in URL (es. workspace cycles): in quel caso fallback al
 * permesso WORKSPACE invece di ritornare false silenziosamente.
 */
...
export const CycleIssueQuickActions = observer(function CycleIssueQuickActions(props: IQuickActionProps) {
  ...
  // auth
  // PATCH v1.31b: PROJECT se projectId in URL, altrimenti WORKSPACE.
