 ...
 * Pattern v1.23a applicato in modo difensivo: il dropdown e' usato in
 * context module (URL ha projectId) quindi il comportamento non cambia.
 * Senza patch, qualsiasi futuro refactor che renderizzi il dropdown
 * fuori dal context project finirebbe per disabilitare le azioni.
 */
...
export const ModuleIssueQuickActions = observer(function ModuleIssueQuickActions(props: IQuickActionProps) {
  ...
  const { workspaceSlug, moduleId, projectId } = useParams();
  // store hooks
