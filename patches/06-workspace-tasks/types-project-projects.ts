 ...
 *  Aggiunto IPartialProject.is_hidden per supportare progetti "fittizi"
 *  workspace-level (Opzione A v1.22). Vedi anche backend project-model.py
 *  v1.22a (campo Project.is_hidden con db_index).
 */
...
export interface IPartialProject {
  ...
  network?: number;
  // PATCH v1.22b: flag per progetti "fittizi" workspace-level (Opzione A
  // v1.22). Quando true, il progetto e' nascosto dal sidebar Projects e
  // dai picker stock. Backend: Project.is_hidden in v1.22a.
  is_hidden?: boolean;
  // Timestamps
  created_at?: Date;
  updated_at?: Date;
